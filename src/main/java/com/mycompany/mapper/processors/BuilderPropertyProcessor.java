 ...
 * @author ajosse
 */
@SupportedAnnotationTypes("com.mycompany.mapper.BuilderProperty")
...
public class BuilderPropertyProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        for (TypeElement annotation : annotations) {
            ...
            otherMethods.forEach(element -> processingEnv.getMessager().printMessage(Diagnostic.Kind.ERROR, "@BuilderProperty must be applied to a setXxx Method with one argument", element));
            ...
            try {
                ...
                Logger.getLogger(BuilderPropertyProcessor.class.getName()).log(Level.SEVERE, null, ex);
            }
